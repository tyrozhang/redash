...
SQLALCHEMY_DATABASE_URI = os.environ.get("REDASH_DATABASE_URL", os.environ.get('DATABASE_URL', "postgresql://postgres@192.168.200.162/test_wangcheng"))
...
default_query_runners = [
    #1#'redash.query_runner.athena',
    #3#'redash.query_runner.big_query',
    #10#'redash.query_runner.google_spreadsheets',
    #11#'redash.query_runner.graphite',
    ...
    #26#'redash.query_runner.presto',
    #6#'redash.query_runner.databricks',
    'redash.query_runner.hive_ds',
    'redash.query_runner.impala_ds',
    #36#'redash.query_runner.vertica',
    #4#'redash.query_runner.clickhouse',
    #38#'redash.query_runner.yandex_metrica',
    #'redash.query_runner.rockset',
    #34#'redash.query_runner.treasuredata',
    #33#'redash.query_runner.sqlite',
    #7#'redash.query_runner.dynamodb_sql',
    'redash.query_runner.mssql',
    #19#'redash.query_runner.memsql_ds',
    #18#'redash.query_runner.mapd',
    #15#'redash.query_runner.jql',
